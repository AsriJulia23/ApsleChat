...
public class ChatRoom extends AppCompatActivity {
    ...
    private ImageButton sendImgBtn, sendFilesBtn;
    ...
    private void InitializeControllers() {
        ...
        sendImgBtn=(ImageButton)findViewById(R.id.send_message_btn);
        sendFilesBtn=(ImageButton)findViewById(R.id.send_files_btn);
        messageInputText=(EditText)findViewById(R.id.input_message);

        messageAdapter = new MessageAdapter(messagesList);
        userMessagesList = (RecyclerView)findViewById(R.id.private_mesaage_list_of_users);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == 438 && resultCode==RESULT_OK && data!=null && data.getData()!=null){
            ...
            if(!checker.equals("image"))
            {
                ...
                DatabaseReference userMessageKeyRef = rootRef.child("Messages").child(messageReceiverId).child(messageReceiverId).push();
                        ...
                        if(task.isSuccessful())
                        {
                            ...
                            rootRef.updateChildren(messageBodyDetails).addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                    ...
                                    if (task.isSuccessful()){
                                        loadingBar.dismiss();
                                        Toast.makeText(ChatRoom.this,"Message Sent Succesfully...",Toast.LENGTH_SHORT).show();
                                    }else {
                                        loadingBar.dismiss();
